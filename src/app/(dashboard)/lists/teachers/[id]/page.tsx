      ...
      <div className="flex w-full flex-col gap-2 xl:w-1/3">
        <div className="mb-4 rounded-xl bg-white p-4">
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-xs text-gray-500">
            <Link
              href="/classes?supervisorId=67100380f6f34e38ba02201a"
              className="cursor-pointer rounded-md bg-custom-purple p-3"
            >
              Teacher&apos;s Classes
            </Link>
            <Link
              href="/students?teacherId=67100380f6f34e38ba02201a"
              className="cursor-pointer rounded-md bg-custom-sky p-3"
            >
              Teacher&apos;s Students
            </Link>
            <Link
              href="/exams?teacherId=67100380f6f34e38ba02201a"
              className="cursor-pointer rounded-md bg-custom-yellow p-3"
            >
              Teacher&apos;s Exams
            </Link>
            <Link
              href="/lessons?teacherId=67100380f6f34e38ba02201a"
              className="cursor-pointer rounded-md bg-custom-purple p-3"
            >
              Teacher&apos;s Lessons
            </Link>
            <Link
              href="/assignments?teacherId=67100380f6f34e38ba02201a"
              className="cursor-pointer rounded-md bg-custom-sky p-3"
            >
